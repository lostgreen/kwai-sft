...
# Qwen3-VL video budgets. Run this script on one 8-GPU node for Qwen3-VL-8B.
...
# 8B may be tighter than 4B; keep micro batch at 1 and effective batch at 32.
...
run_task vdc scripts/run_videoproxy_desc_10k_lora_1gpu.sh 0 \
  qwen3vl8b_videoproxy_vdc10k_lora_2ep_8gpu_256f_tok8192_len16k_rerun
run_task dvc scripts/run_videoproxy_dvc_10k_lora_1gpu.sh 1 \
  qwen3vl8b_videoproxy_dvc10k_lora_2ep_8gpu_256f_tok8192_len16k_rerun
run_task proxy scripts/run_videoproxy_proxy_mix_sft_lora_1gpu.sh 2 \
  qwen3vl8b_videoproxy_proxy_mix_sft_lora_2ep_8gpu_256f_tok8192_len16k_rerun
